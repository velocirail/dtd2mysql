...
import {CSVRow, readCSV} from "../gtfs/import/CSVReader";

/**
 * GTFS writes a date as YYYYMMDD. links.txt takes its dates from a date column instead, so they arrive
 * as YYYY-MM-DD, and the two are made to agree rather than left to whichever database is reading them.
 */
